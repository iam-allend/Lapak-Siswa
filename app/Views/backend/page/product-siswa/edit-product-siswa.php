    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?= base_url('manage-product-siswa/update/' . $product['id_product']) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="id_admin" required>
                                    ...
                                    <?php foreach ($admins as $admin): ?>
                                        <option value="<?= $admin['id_admin'] ?>" <?= old('id_admin', $product['id_admin']) == $admin['id_admin'] ? 'selected' : '' ?>>
                                            <?= esc($admin['full_name']) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
...
<script>
    function deleteImage(imageId) {
        if (confirm('Yakin ingin menghapus gambar ini?')) {
            window.location.href = '<?= base_url('manage-product-siswa/delete-image/') ?>' + imageId;
        }
    }
</script>
