...
<?= $this->include('backend/layOutTemplate/sidebar'); ?>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Kelola Admin</h4>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td><?= $admin['email'] ?></td>
                            <td><?= $admin['gender'] ?></td>
                            <td><span class="badge bg-label-success me-1"><?= $admin['status_registrasi'] ?></span></td>
                            <td>
