    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <!-- Ubah action ke endpoint update kelas -->
                <form action="<?= base_url('manage-kelas/update/' . $kelas['id_kelas']) ?>" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama Kelas</label>
                        <input type="text" class="form-control" name="nama" value="<?= old('nama', $kelas['nama']) ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="wali_kelas" value="<?= old('wali_kelas', $kelas['wali_kelas']) ?>">
                    </div>
