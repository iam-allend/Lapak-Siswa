        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php if (!empty($transaction)): ?>
                    <form action="<?= base_url('manage-order-product-indper/update/' . $transaction['id_transaksi']) ?>" method="post">
                        <!-- Detail Transaksi -->
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="<?= $transaction['nama_industri'] ?>" readonly>
                                </div>
                                <div class="mb-3">
