...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between">
            ...
            <a href="<?= base_url('manage-order-product-indper/create') ?>">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <small>Industri: <?= $transaction['nama_industri'] ?></small>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php if ($transaction['status_order'] !== 'selesai'): ?>
                                    ...
                                    <a href="<?= base_url('manage-order-product-indper/edit/' . $transaction['id_transaksi']) ?>" class="btn btn-outline-primary text-decoration-none">
                                        <i class='bx bxs-edit'></i>
                                    </a>
                                    <a href="<?= base_url('manage-order-product-indper/delete/' . $transaction['id_transaksi']) ?>" class="btn btn-outline-danger text-decoration-none" onclick="return confirm('Yakin ingin menghapus transaksi ini? Saldo customer akan dikembalikan!');">
