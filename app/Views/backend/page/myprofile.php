                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                          src="<?= base_url('img_user/'. session('url_image'))?>"
                          alt="user-avatar"
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form action="<?= base_url('update-profile-admin')?>" method="POST">
                        <div class="row">
                          <input type="hidden" name="id" value="<?= session('id_level')?>">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" name="username" value="<?= session('username')?>" />
                          </div>
                          <div class="mb-3 col-md-6">
