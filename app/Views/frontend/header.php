...
<body>
  ...
  <div class="header" id="header">
          ...
          <div class="col-md-9">
            <div class="header-right">
              <ul>
                ...
                <li>
                  <i class="fas bxs-shopping-bag"></i>
                ...
                <li>
                  ...
                  <li class="fas fa-user-alt"></li> <a href="/dashboard">Login</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="navigation" id="navigation" style="background-color:#vmFF8C00;">
		  ...
		  <ul class="dropdown-menu small-menu">
		     <a href="aboutus.php">Who we Are</a>
			  <a href="#">Profile</a>
                ...
                <!-- <li class="nav-item dropdown">
                  <a class="nav-link" href="/shop" data-toggle="dropdown">Produk<i class="fas fa-chevron-down"></i></a>
                  <ul class="dropdown-menu small-menu">
