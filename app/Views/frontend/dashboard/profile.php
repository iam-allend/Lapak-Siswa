                ...
                <div class="row mt-5 align-items-center">
                    <div class="col-md-3 text-center mb-5">
                        <div class="avatar avatar-xl">
                            <img src="https://down-id.img.susercontent.com/file/id-11134207-7r98v-lq9tbebii9za17"
                    ...
                    <div class="col">
                        <div class="row align-items-center">
                            <div class="col-md-7">
                                <h4 class="mb-1">Bambang Engkol</h4>
                                <p class="small mb-3"><span class="badge badge-dark">Username database</span></p>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-7">
                            ...
                            <div class="col">
                                <p class="small mb-0 text-muted">Lorem, ipsum dolor.</p>
                                <p class="small mb-0 text-muted">Pekunden Tengah</p>
                        ...
                        <div class="card mb-4 shadow">
                            <div class="card-body my-n3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <a href="/saldo">
                                            <h3 class="h5 mt-4 mb-1">Saldo</h3>
                                        </a>
                                        <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            Mauris blandit nisl ullamcorper, rutrum metus in, congue lectus.</p>
                                    </div> <!-- .col -->
                            ...
                            <div class="card-footer">
                                <a href="" class="d-flex justify-content-between text-muted"><span>halaman
                                        Saldo</span><i class="fe fe-chevron-right"></i></a>
                            </div> <!-- .card-footer -->
                        </div> <!-- .card -->
                    </div> <!-- .col-md-->
                    <div class="col-md-4">
                        <div class="card mb-4 shadow">
                            <div class="card-body my-n3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <a href="/orders">
                                            <h3 class="h5 mt-4 mb-1">History Orders</h3>
                                        </a>
                                        <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            Mauris blandit nisl ullamcorper, rutrum metus in, congue lectus.</p>
                                    </div> <!-- .col -->
                            ...
                            <div class="card-footer">
                                <a href="" class="d-flex justify-content-between text-muted"><span>Notification
                                        History</span><i class="fe fe-chevron-right"></i></a>
                            </div> <!-- .card-footer -->
                        </div> <!-- .card -->
                    </div> <!-- .col-md-->
                </div> <!-- .row-->
